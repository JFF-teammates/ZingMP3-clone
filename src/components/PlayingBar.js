...
<div class="add_to_library">
    <div class="wrap_icon">
        <div class="icon_title_panel heart">Thêm vào thư viện</div>
        <svg class="icon icon_add_to_library heart" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 217.408 217.408">
    ...
    <div class="wrap_icon">
        <div class="icon_title_panel see_more">Xem thêm</div>
        <svg class="icon icon_add_to_library see_more" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 210 210">
...
{/* <!-- bar_for_playing --> */}
<div class="bar_for_playing">

    {/* <!-- subbar top --> */}
    <div class="subbar_for_playing top">
        <div class="wrap_icon play_random">
            <div class="icon_title_panel play_random">Phát ngẫu nhiên</div>
            <svg class="icon icon_bar_for_playing play_random" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 230.055 230.055">
        ...
        <div class="wrap_icon step">
            {/* <!-- <div class="icon_title_panel step_backward">Phát bài trước</div> --> */}
            <svg class="icon icon_bar_for_playing step_backward" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024">
        ...
        <div class="wrap_icon pause">
            <svg class="icon icon_bar_for_playing pause" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 485 485">
        ...
        <div class="wrap_icon step">
            <div class="icon_title_panel step_forward">
            ...
            <svg class="icon icon_bar_for_playing step_forward" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024">
        ...
        <div class="wrap_icon repeat">
            <div class="icon_title_panel repeat">Bật phát lại tất cả</div>
            <svg class="icon icon_bar_for_playing repeat" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 51.4 51.4">
    ...
    {/* <!-- subbar bottom --> */}
    <div class="subbar_for_playing bottom">
        <span>00:00</span>
        <input type="range" value="0" id="range_duration_playingBar" />
        <span>00:00</span>
    </div>
</div>
...
{/* <!-- options --> */}
<div class="options">
    <div class="wrap_icon mv">
        {/* <!-- <div class="icon_title_panel mv">oke</div> --> */}
        <svg class="icon icon_options mv" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 381.379 381.379">
    ...
    <div class="wrap_icon">
        <div class="icon_title_panel micro">Xem lời bài hát</div>
        <svg class="icon icon_options micro" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 94.142 94.142">
    ...
    <div class="wrap_icon">
        <div class="icon_title_panel float_screen">Chế độ cửa sổ</div>
        <svg class="icon icon_options float_screen" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 396 396">
    ...
    <div class="wrap_icon speaker_input">
        <div class="wrap_icon speaker">
            {/* <!-- <div class="icon_title_panel speaker">oke</div> --> */}
            <svg class="icon icon_options speaker" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 92 92">
        ...
        <input type="range" value="0" id="rangeDuration_speaker_options" />
    </div>
    <div id="cross"></div>
    <div class="wrap_icon">
        {/* <!-- <div class="icon_title_panel list_music">oke</div> --> */}
        <svg class="icon icon_options list_music" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
